<div class="container-fluid" id="orientation-step">
    <div class="row full-height-step">
        ...
        <form role="form">
            <div class="col-md-6 col-lg-6 eighty-height">
                <div class="step-img-parent">
                    <img class="img-responsive step-img" src="http://lorempixel.com/650/300/abstract" alt="Horizontal">
                </div>
                <div class="radio">
            ...
            <div class="col-md-6 col-lg-6 eighty-height">
                <div class="step-img-parent">
                    <img class="img-responsive step-img" src="http://lorempixel.com/400/650/abstract" alt="Vertical">
                </div>
                <div class="radio">
